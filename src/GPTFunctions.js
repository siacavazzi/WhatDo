...
export const functions = [
    ...
    {
        "name": "doMath",
        "description": "Performs basic arithmetic operations based on the given operator.",
        "parameters": {
            "type": "object",
            "properties": {
                "a": {
                    "type": "number",
                    "description": "The first operand in the operation."
                },
                "b": {
                    "type": "number",
                    "description": "The second operand in the operation."
                },
                "operator": {
                    "type": "string",
                    "description": "The arithmetic operator to be applied. Supported operators are '+', '-', '*', and '/'."
                }
            },
